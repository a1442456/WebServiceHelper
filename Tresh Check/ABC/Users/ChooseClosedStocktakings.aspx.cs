...
{
    public partial class ChooseClosedStocktakings : System.Web.UI.Page
    {
        ...
        private void ShowClosedStocktakings()
        {
            ...
            TableView tblClosed = new TableView(pnlClosedStocktakings, ds.Tables[0], "Закрытые:");
            tblClosed.SortDirect = GetGridViewSortDirection(tblClosed.Caption);
            pnlClosedStocktakings = tblClosed.PanelTableView;
        }
        ...
        private List<StockTakingDetails> GetAvailableStocktackingsByDate(DateTime date)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand sqlComm = new SqlCommand("GetClosedStocktakingByStocktakingDate", conn);
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            if (clndrStocktakingDate.SelectedDate != null && ddlStocktakingDepartment.SelectedValue != string.Empty)
            {
                ...
                Session["ClosedStockTakingDetails"] = details;
                Response.Redirect("..\\Users\\ClosedStocktakingDetails.aspx");
            }
            else
            {
