<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainPage.Master" AutoEventWireup="true" CodeBehind="ChooseStocktaking.aspx.cs" Inherits="WebTrashCheck.Users.ChooseStocktaking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphGreetings" runat="server">
     <asp:Label ID="lblGreetings" runat="server">Choose Stocktaking</asp:Label>
    <br />
    <asp:Label ID="lblGreetingsRus" runat="server" CssClass="lblGreetingsRus">Выберите инвентаризацию</asp:Label>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <asp:Table runat="server" ID="tblStocktakingDetails">
     ...
     <asp:Panel runat="server" ID="pnlStocktakings"></asp:Panel>
</asp:Content>
